...
Players.PlayerAdded:Connect(function(player)
    ...
    -- Start game if we have at least 2 players and game isn't running
    if #gameState.players >= 2 and not gameState.isGameRunning then
        print("Starting game with " .. #gameState.players .. " players")
        startGame()
    end
end)
